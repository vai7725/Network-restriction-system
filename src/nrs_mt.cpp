// Multi-threaded NRS Engine - Fixed Version
...
public:
    ...
    NRSEngine(const Config &cfg) : config_(cfg)
    {
        int total_fps = cfg.num_lbs * cfg.fps_per_lb;

        std::cout << "\n";
        std::cout << "╔══════════════════════════════════════════════════════════════╗\n";
        std::cout << "║              NRS ENGINE v2.0 (Multi-threaded)                 ║\n";
        std::cout << "╠══════════════════════════════════════════════════════════════╣\n";
...
{
    std::cout << R"(
NRS Engine v2.0 - Multi-threaded Network Restriction System
========================================================

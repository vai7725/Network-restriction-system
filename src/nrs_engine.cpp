...
// ============================================================================
// NRSEngine Implementation
// ============================================================================

NRSEngine::NRSEngine(const Config& config)
    : config_(config), output_queue_(10000) {
    
    std::cout << "\n";
    std::cout << "╔══════════════════════════════════════════════════════════════╗\n";
    std::cout << "║                    NRS ENGINE v1.0                            ║\n";
    std::cout << "║               Network Restriction System                     ║\n";
    std::cout << "╠══════════════════════════════════════════════════════════════╣\n";
...
bool NRSEngine::initialize() {
    ...
    std::cout << "[NRSEngine] Initialized successfully\n";
    return true;
}

void NRSEngine::start() {
    if (running_) return;
    ...
    // Start output thread
    output_thread_ = std::thread(&NRSEngine::outputThreadFunc, this);
    ...
    std::cout << "[NRSEngine] All threads started\n";
}
